...
public class MethodMetrics extends CommonMetrics {
     ...
     */
    protected MethodMetrics(String name, String sig, String type, int modifiers, boolean isConstructor, boolean isInitializer,
            ClassMetrics cm) {
        super();
        
        JavaClass jclass = cm.getJavaClass();
        jmethod = new JavaMethod(name, sig, type, modifiers, isConstructor, isInitializer, jclass);
